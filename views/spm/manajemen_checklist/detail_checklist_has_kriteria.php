            ...
            <div class="card-header pb-0">
                <div class="row d-flex justify-content-between">
                    <div class="col-sm-6 col-4">
                        <h6>Detail Penilaian Auditor <span class="text-warning"><?= $checklist_has_kriteria->checklist()->ami()->tahun ?></span></h6>
                    </div>
                </div>
            </div>
...
<div class="row text-left">
    <div class="div">
        <?php if ($last_year_ami == $checklist_has_kriteria->checklist()->ami()->tahun): ?>
            <a href="<?= APP_PATH ?>/spm/manajemen-checklist/update/<?= $checklist_has_kriteria->checklist()->id ?>" type="button" class="btn btn-sm bg-gradient-secondary">Kembali</a>
        <?php else: ?>
