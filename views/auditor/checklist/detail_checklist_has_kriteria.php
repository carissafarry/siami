                ...
                <div class="row mb-4">
                    ...
                    <?php if ($prev_checklist && ($last_year_ami != $checklist_has_kriteria->checklist()->ami()->tahun)): ?>
                        <div class="col-12">
                            ...
                            <span class="badge bg-gradient-<?= (strtolower($checklist_has_kriteria->tinjauan_efektivitas) == 'efektif') ? 'success' : '' ?>" style="white-space: pre-wrap;"><?= $checklist_has_kriteria->tinjauan_efektivitas ?: 'tidak efektif' ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
