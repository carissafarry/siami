...
DROP TABLE "SIAMI"."AMI";
DROP TABLE "SIAMI"."AREA";
DROP TABLE "SIAMI"."AUDITEE";
DROP TABLE "SIAMI"."AUDITOR";
DROP TABLE "SIAMI"."CHECKLIST";
DROP TABLE "SIAMI"."KRITERIA";
DROP TABLE "SIAMI"."PERMISSION";
DROP TABLE "SIAMI"."ROLE";
DROP TABLE "SIAMI"."SPM";
DROP TABLE "SIAMI"."STANDAR";
DROP TABLE "SIAMI"."STATUS";
DROP TABLE "SIAMI"."USER_DETAILS";
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SIAMI"."USER_DETAILS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Table AMI
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SIAMI"."CHECKLIST" 
   (	"ID" NUMBER, 
	...
	"AUDITEE_ID" NUMBER, 
	"TGL_TERBIT" DATE, 
	"NO_IDENTIFIKASI" VARCHAR2(20), 
	"NO_REVISI" VARCHAR2(20), 
	"STATUS" VARCHAR2(20), 
	"CREATED_AT" TIMESTAMP (6) WITH LOCAL TIME ZONE DEFAULT current_timestamp, 
	"UPDATED_AT" TIMESTAMP (6) WITH LOCAL TIME ZONE DEFAULT current_timestamp
   ) ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "SIAMI"."KRITERIA" 
   (	"ID" VARCHAR2(20), 
	"STANDAR_ID" NUMBER, 
	"KODE" VARCHAR2(20), 
	"KRITERIA" VARCHAR2(225), 
	"KET_NILAI" VARCHAR2(225), 
	"CATATAN" VARCHAR2(225), 
	"CREATED_AT" TIMESTAMP (6) WITH LOCAL TIME ZONE DEFAULT current_timestamp, 
	"UPDATED_AT" TIMESTAMP (6) WITH LOCAL TIME ZONE DEFAULT current_timestamp
   ) ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SIAMI.USER_DETAILS (ID,NET_ID,ROLE_ID,AREA_ID,FOTO,TELP,JABATAN,PERIODE,CREATED_AT,UPDATED_AT,USER_TYPE) values ('1','carissafarry@gmail.com','1','1','1.jpg','123','Kaprodi','2039/2094',to_timestamp('24-04-2022 15.55.22,717000000','DD-MM-RRRR HH24.MI.SSXFF'),to_timestamp('24-04-2022 15.55.22,717000000','DD-MM-RRRR HH24.MI.SSXFF'),'1');
Insert into SIAMI.USER_DETAILS (ID,NET_ID,ROLE_ID,AREA_ID,FOTO,TELP,JABATAN,PERIODE,CREATED_AT,UPDATED_AT,USER_TYPE) values ('2','muarifin@gmail.com','1','2','2.jpg','124','Divisi Perencanaan','2039/2048',to_timestamp('24-04-2022 15.55.22,722000000','DD-MM-RRRR HH24.MI.SSXFF'),to_timestamp('24-04-2022 15.55.22,722000000','DD-MM-RRRR HH24.MI.SSXFF'),'2');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index USER_DETAILS_UK1
--------------------------------------------------------

  CREATE UNIQUE INDEX "SIAMI"."USER_DETAILS_UK1" ON "SIAMI"."USER_DETAILS" ("USER_TYPE") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SIAMI"."USER_DETAILS" ADD CONSTRAINT "USER_DETAILS_UK1" UNIQUE ("USER_TYPE") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SIAMI"."AUDITEE" ADD CONSTRAINT "AUDITEE_FK1" FOREIGN KEY ("USER_ID")
	  REFERENCES "SIAMI"."USER_DETAILS" ("USER_TYPE") ENABLE;
