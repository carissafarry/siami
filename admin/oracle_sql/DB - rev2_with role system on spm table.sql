...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SIAMI"."USER_DETAILS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 70 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Table AMI
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SIAMI.USER_DETAILS (ID,NET_ID,ROLE_ID,AREA_ID,FOTO,TELP,JABATAN,PERIODE,CREATED_AT,UPDATED_AT,USER_TYPE) values ('52','b@b.com','1','1','a.jpg','a','ab','a',to_timestamp('15-05-2022 11.00.44,791000000','DD-MM-RRRR HH24.MI.SSXFF'),to_timestamp('15-05-2022 11.00.44,791000000','DD-MM-RRRR HH24.MI.SSXFF'),'0');
...
--------------------------------------------------------
  ...
  ALTER TABLE "SIAMI"."KRITERIA" ADD CONSTRAINT "KRITERIA_UK1" UNIQUE ("KRITERIA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
